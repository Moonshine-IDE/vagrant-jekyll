...
#
# The website source code is copied from the host machine to the VM where Jekyll
# can be executed transforming the templates, text files and assets into a static website.
...
PROJECT_SOURCE_IN_HOST="/path/to/JekyllProjectSources"
...
Vagrant.configure(2) do |config|
  ...
  config.vm.provision "shell", inline: "mkdir -p /vagrant/jekyll-project/source/css", privileged: false
